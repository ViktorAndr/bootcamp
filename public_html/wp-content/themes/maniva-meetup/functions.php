...
if (is_admin()) {
    ...
    include_once(get_parent_theme_file_path('/admin/themeinfo/index.php'));

    /* theme demo importer */
    include_once(get_parent_theme_file_path('/admin/tz-importer.php'));
}
...
function maniva_meetup_register_back_end_ct()
{
    ...
    wp_enqueue_script('portfolio_meta_boxesPh;i‰U  Ph;i‰U                  @ûNi‰U          ðFi‰U  ¸h;i‰U          ph;i‰U  2*      ph;i‰U          m/js/portfolio_theme_option.js', false, '1.0', $in_footer = true);
