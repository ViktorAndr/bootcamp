jQuery(document).ready(function(){
    ...
    var tz_show_hide_header_top =   jQuery("#maniva-meetupon-off-header-top"),
        show_hide_header_top    =   tz_show_hide_header_top.attr('value');
    ...
    tz_show_hide_header_top.change(function(){

        var show_hide_header_topChange= tz_show_hide_header_top.attr('value');
    ...
    var tz_choose_back_top      =   jQuery("#maniva-meetup_ChooseBackTop"),
        tz_choose_back_top_val  =   tz_choose_back_top.attr('value');
    ...
    tz_choose_back_top.change(function(){
        var tz_choose_back_top_valChange = tz_choose_back_top.attr('value');
    ...
    var tz_LogoType =   jQuery("#maniva-meetup_logotype"),
        LogoType    =   tz_LogoType.attr('value');
    ...
    tz_LogoType.change(function(){
        var LogoTypeChange= tz_LogoType.attr('value');
        if(LogoTypeChange==1){
            jQuery('#setting_maniva-meetup_logo').slideDown();
            jQuery('#setting_maniva-meetup_logo2').slideDown();
            jQuery('#setting_maniva-meetup_logoText').slideUp();
    ...
    var tz_TZTypecolor =   jQuery("#maniva-meetup_TZTypecolor"),
        TZTypecolor    =   tz_TZTypecolor.attr('value');
    ...
    tz_TZTypecolor.change(function(){

        var show_hide_TZTypecolor = tz_TZTypecolor.attr('value');
    ...
    jQuery("#tab_TzSyle").toggle(function(){
        ...
        jQuery('#tab_CustomFamily').slideDown();
    },function(){
        jQuery('#tab_TZFamily').slideUp();
        jQuery('#tab_CustomFamily').slideUp();
    });

    // jquery favicon option
    var tz_valuefavicon =   jQuery('#maniva-meetup_favicon_onoff'),
        valuefavicon    =   tz_valuefavicon.attr('value');
    ...
    tz_valuefavicon.change(function(){
    ...
    var tz_slider_client_blog   =   jQuery('#maniva-meetupblog_single_slideshows_show'),
        slider_client_blog      =   tz_slider_client_blog.attr('value');
    ...
    tz_slider_client_blog.change(function(){
    ...
    archive_product_value_columns.change(function(){


        var archive_product_value_columns_change = jQuery(this).attr('value');
    ...
    var archive_product_get_value_columns =  archive_product_value_columns.attr('value');
...
// footer
    ...
    var footer_value =  footervalue.attr('value');
    ...
    tz_footerShop.change(function(){

        var footerShopchange = jQuery(this).attr('value');
    ...
    var footerShopvalue =  tz_footerShop.attr('value');
...
tz_background_type.live('change', function () {
    "use strict";
...
jQuery('#setting_' + 'maniva-meetup' + '_background_pattern .background_pattern').live('click', function () {
    "use strict";
