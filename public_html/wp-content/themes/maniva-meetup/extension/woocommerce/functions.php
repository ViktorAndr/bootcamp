...
?>
            ...
            <a class="tz-shop-cart cart-customlocation" href="<?php echo esc_url( wc_get_cart_url() ); ?>" title="<?php esc_html_e('View your shopping cart', 'maniva-meetup'); ?>">
...
?>
        ...
        <div class="tz_meetup_content_product">
            ...
            global $product;
            $maniva_meetup_attachment_ids = $product->get_gallery_attachment_ids();
                        ...
                        <div class="tz_shop_image_product tz_shop_image_list_product<?php echo esc_attr( $maniva_meetup_class_shop_gallery_list ); ?>">
                            ...
                            <?php if ( count( $maniva_meetup_attachment_ids ) > 0 ) : ?>
                                ...
                                <?php foreach( $maniva_meetup_attachment_ids as $maniva_meetup_attachment_id ) : ?>
                                    ...
                                    <div class="tz_shop_gallery_item" data-thumb="<?php echo wp_get_attachment_url( $maniva_meetup_attachment_id ); ?>">
                                        <?php echo wp_get_attachment_image( $maniva_meetup_attachment_id, '' ); ?>
                                    </div>
                    ...
                    <div class="single-images">
                        ...
                        ?>
                            ...
                            <div class="single-images-gallery">
                                ...
                                <div class="single-images-gallery-item" data-thumb="<?php the_post_thumbnail_url(); ?>" data-src="<?php the_post_thumbnail_url(); ?>">
                                ...
                                <?php foreach( $maniva_meetup_attachment_ids as $maniva_meetup_attachment_id ) : ?>
                                    ...
                                    <div class="single-images-gallery-item" data-thumb="<?php echo wp_get_attachment_url( $maniva_meetup_attachment_id ); ?>" data-src="<?php echo wp_get_attachment_url( $maniva_meetup_attachment_id ); ?>">
                                        <?php echo wp_get_attachment_image( $maniva_meetup_attachment_id, '' ); ?>
                                    </div>
