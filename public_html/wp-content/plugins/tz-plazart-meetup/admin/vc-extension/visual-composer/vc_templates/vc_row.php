...
if ( $check_wp_search == 1 ) {
    $css_classes[] = 'tz_check_wp_search';
}
...
if ( $row_hyphen == 1 ):
	...
	$output .='<div class="tzRow_ArrowType4" '.($color_hyphenbg != '' ? 'style="border-top:30px solid '.esc_attr($color_hyphenbg).';"':'').'>';
	$output .='</div>';
