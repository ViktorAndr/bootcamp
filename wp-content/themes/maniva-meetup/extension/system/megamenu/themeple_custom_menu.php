					...
					<div class="menu-item-actions description-wide submitbox">
						...
						<?php if( 'custom' != $item->type ) : ?>
							...
							<p class="link-to-original">
								...
								<?php printf( esc_html__('Original: %s', 'maniva-meetup'), '<a href="' . esc_attr( $item->url ) . '">' . balanceTags( $original_title ) . '</a>' ); ?>
						...
						); ?>"><?php esc_html_e('Remove', 'maniva-meetup'); ?></a> <span class="meta-sep"> | </span> <a class="item-cancel submitcancel" id="cancel-<?php echo esc_attr($item_id); ?>" href="<?php	echo add_query_arg( array('edit-menu-item' => $item_id, 'cancel' => time()), remove_query_arg( $removed_args, admin_url( 'nav-menus.php' ) ) );
