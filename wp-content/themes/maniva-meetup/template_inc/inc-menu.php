            ...
            <div class="tz_meetup_header_option">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="<?php echo ( $maniva_meetup_on_off_header_top == 2 ? 'col-lg-12 col-md-12' : 'col-lg-6 col-md-6' ); ?> col-sm-12 col-xs-12">
                            <div class="tz_meetup_header_option_phone<?php echo esc_attr( $maniva_meetup_position_top_header ); ?>">
                                <span>
                                    ...
                                    <?php echo balanceTags( $maniva_meetup_header_top_phone ); ?>
                                </span>
                                <span>
                                    <img src="<?php echo get_template_directory_uri().'/images/email_meetup.png' ?>" alt="<?php esc_html_e('email','maniva-meetup'); ?>">
                                    <a href="mailto:<?php balanceTags($maniva_meetup_header_top_mail); ?>">
                                        <?php echo balanceTags( $maniva_meetup_header_top_mail ); ?>
                                    </a>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="<?php echo ( $maniva_meetup_on_off_header_top == 3 ? 'col-lg-12 col-md-12' : 'col-lg-6 col-md-6' ); ?> col-sm-12 col-xs-12">
